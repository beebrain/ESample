                        ...
                        <div class="card card-block mb-3">
                            <div class="card-header d-flex justify-content-between">
                                <div class="iq-header-title">
                                    <h4 class="card-title mb-0">ควบคุมหมายเลขเอกสาร</h4>
                                </div>
                            </div>
                            <div class="card-body">
                                <form id="frmMain">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                <label for="exampleInputText1">หมายเลขเอกสาร</label>
                                                <input type="text" class="form-control" name="docnumber" id="docnumber" placeholder="หมายเลขเอกสาร" value="">
                                            </div>
                                            <div class="col">
                                                <label for="exampleInputText1">หมายเลขปฏิบัติการ</label>
                                                <input type="text" class="form-control" name="operationnumber" id="operationnumber" placeholder="หมายเลขปฏิบัติการ" value="">
                                            </div>
                                        </div>
                                    </div>
